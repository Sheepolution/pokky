...
function Rect:getAngle(r)
	...
	return lume.angle(self.x + self.width / 2, self.y + self.height / 2, r.x + (r.width and r.width / 2 or 0), r.y + (r.height and r.height / 2 or 0))
end
